...
function searchUser() {
    for (input = document.getElementById("searchChatUser"),
...
function themeColor(e) {
    ...
    document.querySelectorAll(".theme-color").forEach(function(i) {
        ...
        t = window.getComputedStyle(e[0], null).getPropertyValue("background-image"),
        rgbColorSecondary = t.substring(t.indexOf("b") + 2, t.indexOf(")")),
        rgbColorPrimary = t.substring(t.lastIndexOf("(") + 1, t.lastIndexOf(")") - 1)),
        i.addEventListener("click", function(e) {
            i.id && localStorage.setItem("activeCustomcolor", i.id);
            var t, a, s = document.querySelector("input[name=bgcolor-radio]:checked");
            s && (s = s.id,
            (t = document.getElementsByClassName(s)) && (a = window.getComputedStyle(t[0], null).getPropertyValue("background-image"),
            rgbColorSecondary = a.substring(a.indexOf("b") + 2, a.indexOf(")")),
            rgbColorPrimary = a.substring(a.lastIndexOf("(") + 1, a.lastIndexOf(")") - 1),
    ...
    document.querySelectorAll(".colorpicker-primary").forEach(function() {
        ...
        i.on("clear", function(e) {}).on("cancel", function(e) {}).on("change", function(e, t, a) {
    ...
    document.querySelectorAll(".colorpicker-secondary").forEach(function() {
        var e = localStorage.getItem("colorSecondary") ? "rgba(" + localStorage.getItem("colorSecondary") + ",1)" : "#b966c1"
          , i = Pickr.create({
        ...
        i.on("clear", function(e) {}).on("cancel", function(e) {}).on("change", function(e, t, a) {
            var s = i.getColor().toRGBA().toString(0);
            rgbColorSecondary = s.substring(s.lastIndexOf("(") + 1, s.lastIndexOf(",")),
...
!function() {
    ...
    function r() {
        "users" == d ? (document.getElementById("channel-chat").style.display = "none",
    ...
    e("users.json", function(e, t) {
        ...
        a(),
        document.querySelectorAll("#favourite-users li, #usersList li") && document.querySelectorAll("#favourite-users li, #usersList li").forEach(function(l) {
            l.addEventListener("click", function(e) {
                ...
                document.querySelector(".videocallModal .videocallModal-bg").setAttribute("src", s)) : (document.querySelector(".user-own-img .avatar-sm").setAttribute("src", o),
                document.querySelector(".user-profile-sidebar .profile-img").setAttribute("src", o),
                document.querySelector(".audiocallModal .img-thumbnail").setAttribute("src", o),
                document.querySelector(".videocallModal .videocallModal-bg").setAttribute("src", o));
                ...
                document.getElementById("users-conversation").querySelectorAll(".left .chat-avatar").forEach(function(e) {
                    i ? e.querySelector("img").setAttribute("src", i) : e.querySelector("img").setAttribute("src", o)
                }),
                window.stop()
            })
        }),
        document.querySelectorAll("#channelList li").forEach(function(i) {
            i.addEventListener("click", function(e) {
                ...
                var s = document.getElementById(t).querySelector(".avatar-xs").getAttribute("src");
                null !== s ? (document.querySelector("#channel-chat .user-own-img .avatar-sm").setAttribute("src", s),
                document.querySelector(".user-profile-sidebar .profile-img").setAttribute("src", s),
                document.querySelector(".audiocallModal .img-thumbnail").setAttribute("src", s),
                document.querySelector(".videocallModal .videocallModal-bg").setAttribute("src", s)) : (document.querySelector("#channel-chat .user-own-img .avatar-sm").setAttribute("src", o),
                document.querySelector(".user-profile-sidebar .profile-img").setAttribute("src", o),
                document.querySelector(".audiocallModal .img-thumbnail").setAttribute("src", o),
                document.querySelector(".videocallModal .videocallModal-bg").setAttribute("src", o))
            })
    ...
    e("callList.json", function(e, t) {
        null !== e ? console.log("Something went wrong: " + e) : (callList = t,
        ...
        document.querySelectorAll("#callList li").forEach(function(i) {
            i.addEventListener("click", function(e) {
                ...
                document.querySelector(".audiocallModal .text-truncate").innerHTML = a;
                var s = document.getElementById(t).querySelector(".avatar-xs").getAttribute("src");
                s ? (document.querySelector(".audiocallModal .img-thumbnail").setAttribute("src", s),
                document.querySelector(".videocallModal .videocallModal-bg").setAttribute("src", s)) : (document.querySelector(".audiocallModal .img-thumbnail").setAttribute("src", o),
                document.querySelector(".videocallModal .videocallModal-bg").setAttribute("src", o))
            })
        })
    }),
    e("contacts.json", function(e, t) {
        ...
        document.querySelectorAll(".sort-contact ul li").forEach(function(s) {
            s.addEventListener("click", function(e) {
                ...
                a ? (document.querySelector(".user-own-img .avatar-sm").setAttribute("src", a),
                ...
                document.querySelector(".videocallModal .videocallModal-bg").setAttribute("src", a)) : (document.querySelector(".user-own-img .avatar-sm").setAttribute("src", o),
                document.querySelector(".user-profile-sidebar .profile-img").setAttribute("src", o),
                document.querySelector(".audiocallModal .img-thumbnail").setAttribute("src", o),
                document.querySelector(".videocallModal .videocallModal-bg").setAttribute("src", o)),
                document.getElementById("users-conversation").querySelectorAll(".left .chat-avatar").forEach(function(e) {
                    a ? e.querySelector("img").setAttribute("src", a) : e.querySelector("img").setAttribute("src", o)
                }),
                window.stop()
            })
        }),
    ...
    document.querySelector("#galleryfile-input").addEventListener("change", function() {
        ...
        this.files && [].forEach.call(this.files, function(e) {
            ...
            t.addEventListener("load", function() {
                ...
                C.push(t.result),
                a += '<div class="media-img-list" id="remove-image-' + removeimg + '">          <a href="#">              <img src="' + this.result + '" alt="' + e.name + '" class="img-fluid">          </a>            <i class="ri-close-line image-remove" onclick="removeImage(`remove-image-' + removeimg + '`)"></i>          </div>',
    ...
    l && l.addEventListener("submit", function(e) {
        e.preventDefault();
        var t, a, s, i, l = g, o = g, r = g, n = g, c = g, d = y.value, u = document.querySelector(".image_pre"), m = document.querySelector(".attchedfile_pre"), p = document.querySelector(".audiofile_pre"), f = document.querySelector(".chat-input-feedback");
        0 === d.length ? (f.classList.add("show"),
        setTimeout(function() {
            f.classList.remove("show")
        }, 2e3),
        null != u ? (f.classList.remove("show"),
        t = o,
        a = C,
        ...
        null != a && (s.insertAdjacentHTML("beforeend", '<li class="chat-list right" id="chat-list-' + S + '" >        <div class="conversation-list">            <div class="user-chat-content">                <div class="ctext-wrap">                        <div class="message-img mb-0">' + i + '                    </div>                    </div>                  <div class="conversation-name">                    <small class="text-muted time">' + x() + '</small>                    <span class="text-success check-message-icon"><i class="bx bx-check"></i></span>                </div>          </div>        </li>'),
        _(),
        ...
        C = []) : null != m ? (f.classList.remove("show"),
        function(e, t, a) {
            t = q,
            a = L;
            S++;
            ...
            i.querySelectorAll(".download-file").forEach(function(i) {
                i.addEventListener("click", function(e) {
                    ...
                    window.File && window.FileReader && window.FileList && window.Blob ? (t = new Blob([j[s]],{
                        type: "application/pdf"
                    }),
                    (a = document.createElement("a")).href = window.URL.createObjectURL(t),
                    a.download = j[s].name,
                    a.click()) : alert("The File APIs are not fully supported in this browser.")
                })
            }),
            document.querySelector(".file_Upload ").classList.remove("show")
        }(r, d)) : null != p && (f.classList.remove("show"),
        function(e, t) {
            t = w;
            S++;
    ...
    document.getElementById("user-profile-edit-btn").addEventListener("click", function(e) {
        document.querySelectorAll(".edit-input .form-control").forEach(function(e) {
            ...
            e.disabled ? (t.classList.replace("bxs-pencil", "bxs-save"),
            e.disabled = !1) : (t.classList.replace("bxs-save", "bxs-pencil"),
            e.disabled = !0)
        })
    });
    ...
    function H(e) {
        ...
        a = function(e, t) {
            var l, o, a, i, r, s, n, c;
            null !== e ? console.log("Something went wrong: " + e) : (l = "users" == d ? t[0].chats : t[0].channel_chat,
            document.getElementById(d + "-conversation").innerHTML = "",
            o = 0,
            l.forEach(function(t, e) {
                var a, s, i;
                0 < o ? --o : (a = t.from_id == m ? " right" : " left",
                s = u.find(function(e) {
                ...
                l[e + 1] && t.from_id == l[e + 1].from_id && (o = function(e, t, a) {
                ...
                i += function(e, t, a) {
                    for (var s = 0; e[t] && e[t + 1] && e[t + 1].from_id == a; )
                        s = I(e[t + 1].id, e[t + 1].msg, e[t + 1].has_images, e[t + 1].has_files, e[t + 1].has_audios, e[t + 1].has_videos, e[t + 1].has_dropDown),
                        t++;
                    return s
                }(l, e, t.from_id)),
    ...
    document.getElementById("emoji-btn").addEventListener("click", function() {
        setTimeout(function() {
            ...
            !t || (e = window.getComputedStyle(t) ? window.getComputedStyle(t).getPropertyValue("left") : "") && (e = (e = e.replace("px", "")) - 40 + "px",
            t.style.left = e)
        }, 0)
    })
}(),
...
function removeImage(e) {
    ...
    0 == document.querySelectorAll(".image-remove").length && document.querySelector(".file_Upload").classList.remove("show")
}
function removeAttachedFile() {
    document.getElementById("remove-attechedFile") && (document.getElementsByClassName("attechedFile-remove")[0],
...
function removeAudioFile() {
    document.getElementById("remove-audioFile") && (document.getElementsByClassName("audioFile-remove")[0],
